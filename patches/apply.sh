...
git apply -v ../../device/xiaomi/hermes/patches/framework_base/0004-add-com.mediatek-for-build.patch
git apply -v ../../device/xiaomi/hermes/patches/framework_base/0005-Update-for-mtk.patch
cd ../..
